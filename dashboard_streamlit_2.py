...
def load_data():
    ...
    df = df.rename(columns={
        ...
        "Day_Ahead_Forecast": "Daily Forecast GHI"
    })
...
if day_df.empty:
    ...
    eval_df = day_df.dropna(
        subset=["Actual_GHI", "GFS_GHI", "Daily Forecast GHI"]
    ).copy()
    ...
    if not eval_df.empty:
        ...
        after = eval_df["Daily Forecast GHI"]
